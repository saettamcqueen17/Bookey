...
@Database(entities = {User.class, LibroEntity.class, CatalogoPersonaleEntity.class}, version = 5, exportSchema = false)public abstract class AppDatabase extends RoomDatabase {
